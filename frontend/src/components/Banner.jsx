    ...
    return (
        <section className=" mt-32 w-full bg-yellow-50" >
            <div className="flex flex-col mt-32 items-end pr-20 justify-center  header-banner bg-cover bg-no-repeat bg-left w-92 h-96 custom_banner_css">
                ...
                <div className="rounded-full p-1 box-border mt-8 overflow-hidden ring-red-300 focus:ring-4 w-80 flex items-center mr-16">
                    <a href="#bottom" className="bg-primary px-24 py-3 ml-auto mr-auto overflow-hidden text-white poppins rounded-full ring-blue-300 focus:outline-none focus:ring-4 transform transition duration-700 hover:scale-105"style={{ zIndex:'1'}} onClick={scrollToBottom}>
                        Reserve Table
                    </a>
                </div>
            </div>
